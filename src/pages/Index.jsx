    ...
    return (
      <VStack spacing={8} p={5}>
        <Box as="header" textAlign="center">
          <img src="/logo.png" alt="Queenstown Mini Golf Logo" style="width: 20vw; max-width: 150px;" />
            ...
            <Tr>
              ...
              {players.map((player, playerIndex) => (
                <Td key={playerIndex} isNumeric>
                  <Input ref={playerInputRefs.current[playerIndex]} type="tel" pattern="[0-9]*" inputMode="numeric" fontWeight="bold" color="green.500" style="width: 5vw; max-width: 40px;" value={player.scores[currentHole] === 0 ? "" : player.scores[currentHole]} onChange={(e) => handleScoreChange(playerIndex, currentHole, e.target.value.trim())} size="sm" max="9" borderWidth="2px" borderColor="brand.900" />
                </Td>
              ))}
            </Tr>
